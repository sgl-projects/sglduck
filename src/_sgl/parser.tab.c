...
#line 1250 "src/_sgl/parser.tab.c"
    break;

  case 13: /* geom_expr: UNQUOTED_STRING  */
#line 105 "src/_sgl/parser.y"
                    {
...
#line 1277 "src/_sgl/parser.tab.c"
    break;

  case 18: /* from_clause: FROM TABLE_NAME  */
#line 134 "src/_sgl/parser.y"
                             {
...
#line 1327 "src/_sgl/parser.tab.c"
    break;

  case 23: /* col_expr: UNQUOTED_STRING '(' UNQUOTED_STRING ')'  */
#line 173 "src/_sgl/parser.y"
                                                  {
...
#line 1381 "src/_sgl/parser.tab.c"
    break;

  case 25: /* col_expr: UNQUOTED_STRING  */
#line 215 "src/_sgl/parser.y"
                          {
...
#line 1397 "src/_sgl/parser.tab.c"
    break;

  case 26: /* fn_arg: INTEGER  */
#line 227 "src/_sgl/parser.y"
                {
...
#line 1411 "src/_sgl/parser.tab.c"
    break;

  case 31: /* grouping_expr: col_expr  */
#line 243 "src/_sgl/parser.y"
                        {
...
#line 1424 "src/_sgl/parser.tab.c"
    break;

  case 36: /* collection_expr: col_expr  */
#line 258 "src/_sgl/parser.y"
                          {
...
#line 1437 "src/_sgl/parser.tab.c"
    break;

  case 37: /* scale_clause: SCALE BY scale_list  */
#line 267 "src/_sgl/parser.y"
                                  {}
#line 1443 "src/_sgl/parser.tab.c"
    break;

  case 40: /* scale_expr: UNQUOTED_STRING '(' UNQUOTED_STRING ')'  */
#line 272 "src/_sgl/parser.y"
                                                    {
...
#line 1481 "src/_sgl/parser.tab.c"
    break;

  case 41: /* facet_clause: FACET BY facet_list  */
#line 306 "src/_sgl/parser.y"
                                  {}
#line 1487 "src/_sgl/parser.tab.c"
    break;

  case 44: /* facet_expr: UNQUOTED_STRING direction  */
#line 311 "src/_sgl/parser.y"
                                      {
...
#line 1571 "src/_sgl/parser.tab.c"
    break;


#line 1575 "src/_sgl/parser.tab.c"
